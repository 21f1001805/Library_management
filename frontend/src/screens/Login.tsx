...
// ponytail: the role buttons below stay for now (dev preview of RequireAuth/RequireRole
// guards) — remove them before production, per team decision.
// Redirecting is left entirely to RedirectIfAuthenticated (providers/AuthGuard.tsx) reacting
// to the auth-state change — navigating here too would race its own redirect.
      ...
      <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center gap-4 p-8">
        ...
        {GOOGLE_CLIENT_ID ? (
          ...
          <p className="text-center text-xs text-muted-foreground">
            Google sign-in isn't configured (missing GOOGLE_CLIENT_ID).
          </p>
        )}
