...
export const testimonials: Testimonial[] = [
  { id: 'priyaSharma', name: 'Priya Sharma', rating: 5 },
  { id: 'rahulNair', name: 'Rahul Nair', rating: 5 },
  { id: 'ananyaIyer', name: 'Ananya Iyer', rating: 4 },
  { id: 'karanMalhotra', name: 'Karan Malhotra', rating: 5 },
];
