  ...
  return (
    <svg viewBox="0 0 200 140" aria-hidden="true" focusable="false" className={className}>
      ...
      <g>
        ...
        {/* Open Book on Table */}
        <path
          d="M148 90 Q155 86, 162 89 Q169 86, 176 90 L174 94 Q169 90, 162 93 Q155 90, 150 94 Z"
          fill="var(--color-primary)"
          opacity="0.9"
        />
        ...
        <path
          d="M166 80 C169 80, 169 87, 166 87"
        ...
        {/* Steam Lines */}
        <path
          d="M159 74 C158 71, 160 69, 159 66"
          stroke="var(--color-muted-foreground)"
          strokeWidth="1.2"
          fill="none"
          opacity="0.5"
        ...
        />
        <path
          d="M163 74 C162 71, 164 69, 163 66"
          stroke="var(--color-muted-foreground)"
          strokeWidth="1.2"
          fill="none"
          opacity="0.5"
